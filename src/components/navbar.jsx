...
const Navbar = () => {
  return (
    ...
    <div className='bg-slate-700 text-white text-xl px-10 py-8 font-bold uppercase'>
        ...
        <div className="bg-slate-700 flex flex-row flex-wrap gap-3 justify-end ">
           ...
           <NavLink to={`/project/E-commerce`}  className="font-normal text-lg capitalize cursor-pointer bg-slate-600 py-1 px-5 border border-white rounded-lg  ">03 E-commerce</NavLink >
           <NavLink to={`/project/blog`}  className="font-normal text-lg capitalize cursor-pointer bg-slate-600 py-1 px-5 border border-white rounded-lg  ">04 Blog</NavLink >
        </div>
    </div>
